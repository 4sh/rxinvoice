...
export class VendorDetailComponent implements OnInit {
        ...
        this.route.data.subscribe(data => {
            ...
            this.authService.companyEvents
                .subscribe(companyEvent => {
                    ...
                    this.buildCompanyFiscalYearBounds(this.customer);
                    this.fillCustomerMetrics(this.vendor);
                });
    ...
    public save() {
        if (this.vendor._id) {
            this.companyService.updateCompany(this.vendor).subscribe((company) => {
                    this.vendor = company;
            ...
            this.companyService.createCompany(this.vendor).subscribe((company) => {
                    this.vendor = company;
